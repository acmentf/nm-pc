...
<template>
  <div class="detail-box">
    <div class="liveBroadcast">
      ...
      <div class="fight-box">
        <div v-if="roleselect_info" style="width:100%;height:100%;position:absolute;z-index:2;">
        ...
        <div v-if="data_rank_list.length" class="ranking">
          <div class="chart-box" style="margin-right:90px;">
            ...
            <div class="pie-wrapper">
              <el-image style="width:100px;height:100px;" :src="topData.mnl.team_home.team_img" class="home_img">
                <div slot="error" class="image-slot">
                  <img src="/images/team_default.png" alt width="100" />
                </div>
              </el-image>
              <pie width="140" height="140" type="1"></pie>
            </div>
          </div>
          <div class="center">
            <table-select
          ...
          <div class="chart-box" style="margin-left:90px;">
            ...
            <div class="pie-wrapper">
              <el-image style="width:100px;;height:100px;" :src="topData.mnl.team_away.team_img" class="home_img">
                <div slot="error" class="image-slot">
                  <img src="/images/team_default.png" alt width="100" />
                </div>
              </el-image>
              <pie width="140" height="140"></pie>
            </div>
          </div>
        </div>
