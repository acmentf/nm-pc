    ...
    <div class="liveBroadcast">
          ...
          <div class="centent_box">
            <div class="centent_box_title">
              ...
              <el-image
                ...
                fit="contain"
                style="margin:0 12px 0 20px;width:40px;"
              >
            ...
            <div class="player-info">
              <div style="margin-right:40px;">
                ...
                <div
                  ...
                  :key="index"
                >
                  <img height="44px" :src="item.role_img_url" alt="hero" style="margin-bottom:8px;" />
                  <p>
                    {{item.win}}/
            ...
            <div class="player-info">
              <div class="charts-box">
                <h1 class="charts-title">
                  ...
                  <div class="line red" style="border-bottom: 4px solid #EB47B1;"></div>
                </h1>
                <div class="pie-wrapper">
                  <el-image
      ...
      <div class="history-box">
          ...
          <div class="centent">
            ...
            <div class="centent-table">
              ...
              >
                ...
                <el-table-column label="击杀" align="center">
                  <template slot="header" slot-scope="scope">
                    <div class="custom-header">
                      <img width="18px" height="18px" src="/images/strike.png" alt="strike" /> 击杀
                    </div>
                  </template>
                  <template slot-scope="scope">
                ...
                <el-table-column label="一血/一塔" align="center">
                  <template slot="header" slot-scope="scope">
                    <div class="custom-header">
                      <img width="18px" height="18px" src="/images/firstBlood.png" alt="duration" />一血/一塔
                    </div>
                  </template>
                  <template slot-scope="scope">
                    <div class="pic">
                ...
                <el-table-column label="先五/十杀" align="center">
                  <template slot="header" slot-scope="scope">
                    <div class="custom-header">
                      <img width="18px" height="18px" src="/images/snake.png" alt="duration" /> 先五/十杀
                    </div>
                  </template>
                  <template slot-scope="scope">
                    <div class="pic">
        ...
        <div class="history-right">
          <div v-if="history_battle_gkd.total_home" class="centent">
            <div class="title-text">
              <img
                width="22px"
                height="22px"
              ...
              <el-table-column align="left" label="对战战队">
                ...
                <template slot-scope="scope">
                  <div class="pic-wrapper">
                    <el-image :src="scope.row.TeamImg" class="team-pic" fit="contain">
                      <div slot="error" class="image-slot">
                        <img src="/images/team_default.png" alt />
                      </div>
                    </el-image>
...
export default {
  ...
  async asyncData({ app, params, query, store }) {
    ...
    //let data = await store.dispatch("matchDetail/_getMatchDetail");
  ...
  methods: {
    ...
    async positionChange(subtype) {
      ...
      this.position_list = this.$store.state.matchDetail;
      this.player_info = this.$store.state.matchDetail;
    },
    zoneChange() {},
